...
export const CommWrapper = (targetName, component) => {
  promise.then(Jupyter => {
    Jupyter.notebook.kernel.comm_manager.register_target(targetName, function (comm, msg) {
      ...
      switch (msg.content.data.render) {
        ...
        default:
          return renderInParent(reactComponent, msg)
      }
    })
  })
}
...
const renderInParent = (reactComponent, msg) => {
